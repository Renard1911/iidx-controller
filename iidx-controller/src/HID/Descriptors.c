...
USB_descriptor_configuration_struct configuration_descriptor = {
    ...
    .HID1_joystick_interface = {.Header = {.Size = sizeof(USB_Descriptor_Interface_t), .Type = DTYPE_Interface},
    ...
    .HID1_joystick_hid = {.Header = {.Size = sizeof(USB_HID_Descriptor_HID_t), .Type = HID_DTYPE_HID},
    ...
    .HID1_joystick_in_endpoint = {.Header = {.Size = sizeof(USB_Descriptor_Endpoint_t), .Type = DTYPE_Endpoint},
    ...
    .HID1_joystick_out_endpoint = {.Header = {.Size = sizeof(USB_Descriptor_Endpoint_t), .Type = DTYPE_Endpoint},
    ...
    .HID2_keyboard_interface = {.Header = {.Size = sizeof(USB_Descriptor_Interface_t), .Type = DTYPE_Interface},
    ...
    .HID2_keyboard_hid = {.Header = {.Size = sizeof(USB_HID_Descriptor_HID_t), .Type = HID_DTYPE_HID},
    ...
    .HID2_keyboard_in_endpoint = {.Header = {.Size = sizeof(USB_Descriptor_Endpoint_t), .Type = DTYPE_Endpoint},
    ...
    .HID3_mouse_interface = {.Header = {.Size = sizeof(USB_Descriptor_Interface_t), .Type = DTYPE_Interface},
    ...
    .HID3_mouse_hid = {.Header = {.Size = sizeof(USB_HID_Descriptor_HID_t), .Type = HID_DTYPE_HID},
    ...
    .HID3_mouse_in_endpoint = {.Header = {.Size = sizeof(USB_Descriptor_Endpoint_t), .Type = DTYPE_Endpoint},
...
const USB_Descriptor_String_t PROGMEM
    ...
    LEDString_07 = USB_STRING_DESCRIPTOR(L"Start Button"),
    LEDString_08 = USB_STRING_DESCRIPTOR(L"Effect Button"),
    LEDString_09 = USB_STRING_DESCRIPTOR(L"VEFX Button");
